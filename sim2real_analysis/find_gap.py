...
from utils import speed_and_yawrate, xcorr_delay, desired_heading, safe_diff, save_plots
...
def main() -> None:
    ...
    save_plots(args.out, sim, real, arc, cp, dyn)

    metrics = {
        "inputs": {
            "sim_csv": args.sim,
            "real_csv": args.real,
            "sim_yaw_units_inferred": sim.yaw_units,
            "real_yaw_units_inferred": real.yaw_units,
        },
